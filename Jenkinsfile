                    ...
                    script {
                        ...
                        sh '''
                            ...
                            #    echo "Using assembly version: $CVER.$BUILD_NUMBER"
                                ...
                                buildah build --build-arg TRACER_VERSION=$DD_AGENT_VERSION  --platform=linux/arm64 --arch arm64 --tag ${ECR_TAGGED_IMG}-arm64 --manifest ${ECR_TAGGED_IMG}-arm64 ${PROJECT_DIR}/Dockerfile-test
                            #fi
                    '''
                    }
                }
