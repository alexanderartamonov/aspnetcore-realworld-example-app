...
curl -o /app/datadog-dotnet-apm_${TRACER_VERSION}_${TARGETARCH}.deb -LO https://github.com/DataDog/dd-trace-dotnet/releases/download/v${TRACER_VERSION}/datadog-dotnet-apm_${TRACER_VERSION}_${TARGETARCH}.deb 
